...
from models.T5_with_efficientnet import T5ForConditionalGenerationWithVision

class T5ExecutorWithVision(BaseExecutor):
    ...
    def _generative_step(self, sample_batched, batch_idx):
        ...
        encoder_outputs, encoder_attention_mask = self.model.get_text_image_encoding(
            **encoder_kwargs
        )
