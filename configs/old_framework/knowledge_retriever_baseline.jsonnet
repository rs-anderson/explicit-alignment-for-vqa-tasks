...

{
  ...
  "model_config": {
    "base_model": "T5",
    "ModelClass": "RetrieverT5",
    "QueryEncoderModelClass": "T5EncoderModel",
    "QueryEncoderConfigClass": "T5Config",
    "QueryEncoderModelVersion": "t5-base",
    "ItemEncoderModelClass": "T5EncoderModel",
    "ItemEncoderConfigClass": "T5Config",
    "ItemEncoderModelVersion": "t5-base",
    "TokenizerClass": "T5Tokenizer",
    "TokenizerModelVersion": "t5-base",
    "pretrained": 1,
    "modules": [
    ],
