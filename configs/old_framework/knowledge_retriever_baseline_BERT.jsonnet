...
local img_data_path_train = "../data/ok-vqa/train2014";
local img_data_path_test = "../data/ok-vqa/val2014";
...

{
  ...
  "model_config": {
    ...
    "ItemEncoderModelClass": "BertModel",
    "ItemEncoderConfigClass": "BertConfig",
    "ItemEncoderModelVersion": "bert-base-uncased",
