...

{
  ...
  "model_config": {
    ...
    "ModelClass": "CustomVisionEncoderDecoderModel",
    "ConfigClass": "VisionEncoderDecoderConfig",
    "EncoderModelClass": "VisualBertModel",
    "EncoderConfigClass": "VisualBertConfig",
    "EncoderModelVersion": "uclanlp/visualbert-vqa-coco-pre",
    ...
    "pretrained": 1,
    "modules": [
      "text_and_feature_parallel",
    ],
    "input_modules": [
      {"type": "VisionInput",  "option": "text_and_feature"},
