...

{
  ...
  "model_config": {
    "base_model": "T5",
    "ModelClass": "T5ForConditionalGenerationDualEncoderViT",
    "DualEncoderModelClass": "ViTModel",
    "DualEncoderConfigClass": "ViTConfig",
    "DualEncoderModelVersion": "google/vit-base-patch16-224-in21k",
