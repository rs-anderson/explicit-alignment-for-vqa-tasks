...
def consolidate(
    ...
    GEN_SPECIAL_TOKENS['additional_special_tokens'] = gen_tokenizer.additional_special_tokens + GEN_SPECIAL_TOKENS['additional_special_tokens']
    gen_tokenizer.add_special_tokens(GEN_SPECIAL_TOKENS)
    ...
    if "<BOV>" not in gen_tokenizer.additional_special_tokens:
        QS_SPECIAL_TOKENS['additional_special_tokens'] = gen_tokenizer.additional_special_tokens + QS_SPECIAL_TOKENS['additional_special_tokens']
    else:
        QS_SPECIAL_TOKENS['additional_special_tokens'] = gen_tokenizer.additional_special_tokens
    question_encoder_tokenizer.add_special_tokens(QS_SPECIAL_TOKENS)
    
    question_encoder_tokenizer.save_pretrained(dest_dir / "question_encoder_tokenizer/")


    # rag_model.generator.resize_token_embeddings(len(gen_tokenizer))
    # rag_model.question_encoder.resize_token_embeddings(len(question_encoder_tokenizer))
